...
function runWaterExtraction() {
  ...
  if (waterFeatures) {
    ...
    Export.image.toDrive({
      image: mndwiExport,
      description: 'MNDWI_Index_' + startDate.replace(/-/g, '') + '_' + endDate.replace(/-/g, ''),
      folder: 'GEE_WaterExtraction',
      fileNamePrefix: filePrefix + '_MNDWI',
      region: studyRegion,
      scale: 10,
      maxPixels: 1e13,
      crs: 'EPSG:4326',
    ...
    Export.image.toDrive({
      image: aweishExport,
      description: 'AWEIsh_Index_' + startDate.replace(/-/g, '') + '_' + endDate.replace(/-/g, ''),
      folder: 'GEE_WaterExtraction',
      fileNamePrefix: filePrefix + '_AWEIsh',
      region: studyRegion,
      scale: 10,
      maxPixels: 1e13,
      crs: 'EPSG:4326',
    ...
    Export.image.toDrive({
      image: wi2015Export,
      description: 'WI2015_Index_' + startDate.replace(/-/g, '') + '_' + endDate.replace(/-/g, ''),
      folder: 'GEE_WaterExtraction',
      fileNamePrefix: filePrefix + '_WI2015',
      region: studyRegion,
      scale: 10,
      maxPixels: 1e13,
      crs: 'EPSG:4326',
