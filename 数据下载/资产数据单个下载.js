...
/**
 * 获取哨兵-2 SR数据
 * 说明：median()会保留所有可用波段，然后通过select()只选择B1-B12光谱波段
 * 包含波段：B1, B2, B3, B4, B5, B6, B7, B8, B8A, B9, B11, B12（除B10，SR产品中不存在）
...
// 计算影像中值合成，使用geometry进行精确裁剪，只保留B1-B12光谱波段
...
print('说明：导出的GeoTIFF包含B1-B12光谱波段（共12个），不包含辅助波段');
